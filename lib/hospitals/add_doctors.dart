...
class HAddDoctorsPage extends StatefulWidget {
  const HAddDoctorsPage({Key? key}) : super(key: key);

  @override
  _HAddDoctorsPageState createState() => _HAddDoctorsPageState();
}
...
class _HAddDoctorsPageState extends State<HAddDoctorsPage> {
