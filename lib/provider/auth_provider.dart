...
import 'package:medapp/screens/otp_screen.dart';
...
class AuthProvider extends ChangeNotifier {
    ...
    try {
      await _firebaseAuth.verifyPhoneNumber(
        ...
        verificationFailed: (error) {
          // Handle the specific error - A network error
          if (error.code == 'network-request-failed') {
            // Handle network error gracefully
            showSnackBar(context, 'A network error occurred. Please check your internet connection and try again.');
          } else {
  ...
  Future getDataFromFirestore() async {
    await _firebaseFirestore
      ...
      _userModel = UserModel(
        ...
        uid: snapshot['uid'],  // Keep this as it is
        phoneNumber: snapshot['phoneNumber'],  // Keep this as it is
  ...
  Future saveBookingDataToFirebase({
    required BuildContext context,
